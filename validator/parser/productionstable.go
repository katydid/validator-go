...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `StartXor : OpenParen Pattern Caret ContinueXor CloseParen	<< &Pattern{Xor: &Xor{
      OpenParen: X[0].(*Keyword),
      LeftPattern: X[1].(*Pattern),
      Caret: X[2].(*Keyword),
      RightPattern: X[3].(*Pattern),
	...
	ProdTabEntry{
		String: `ContinueXor : ContinueXor Caret Pattern	<< &Pattern{Xor: &Xor{
      LeftPattern: X[0].(*Pattern),
      Caret: X[1].(*Keyword),
      RightPattern: X[2].(*Pattern),
    }}, nil >>`,
	...
	ProdTabEntry{
		String: `StartNameConj : OpenParen NameExpr Ampersand ContinueNameConj CloseParen	<< &NameExpr{NameConj: &NameConj{
      OpenParen: X[0].(*Keyword),
      Left: X[1].(*NameExpr),
      Ampersand: X[2].(*Keyword),
      Right: X[3].(*NameExpr),
	...
	ProdTabEntry{
		String: `ContinueNameConj : ContinueNameConj Ampersand NameExpr	<< &NameExpr{NameConj: &NameConj{
      Left: X[0].(*NameExpr),
      Ampersand: X[1].(*Keyword),
      Right: X[2].(*NameExpr),
    }}, nil >>`,
	...
	ProdTabEntry{
		String:     `Caret : "^"	<< &Keyword{Value: "^"}, nil >>`,
		Id:         "Caret",
		NTType:     65,
		Index:      173,
		NumSymbols: 1,
