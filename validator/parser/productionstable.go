...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `StartExtension : Dollar id OpenParen CloseParen	<< &Pattern{Extension: &Extension{
      Dollar: X[0].(*Keyword),
      Name: newString(X[1]),
      OpenParen: X[2].(*Keyword),
      CloseParen: X[3].(*Keyword),
    }}, nil >>`,
		Id:         "StartExtension",
		NTType:     18,
		...
		NumSymbols: 4,
		ReduceFunc: func(X []Attrib, C interface{}) (Attrib, error) {
			return &Pattern{Extension: &Extension{
				Dollar:     X[0].(*Keyword),
				Name:       newString(X[1]),
				OpenParen:  X[2].(*Keyword),
				CloseParen: X[3].(*Keyword),
	...
	ProdTabEntry{
		String: `StartExtension : Dollar id OpenParen Pattern CloseParen	<< &Pattern{Extension: &Extension{
      Dollar: X[0].(*Keyword),
      Name: newString(X[1]),
      OpenParen: X[2].(*Keyword),
	...
	ProdTabEntry{
		String: `StartExtension : Dollar id OpenParen Pattern Comma ContinueExtension CloseParen	<< &Pattern{Extension: &Extension{
      Dollar: X[0].(*Keyword),
      Name: newString(X[1]),
      OpenParen: X[2].(*Keyword),
      LeftPattern: X[3].(*Pattern),
	...
	ProdTabEntry{
		String: `StartExtension : Dollar id OpenParen Pattern Comma ContinueExtension Comma CloseParen	<< &Pattern{Extension: &Extension{
      Dollar: X[0].(*Keyword),
      Name: newString(X[1]),
      OpenParen: X[2].(*Keyword),
      LeftPattern: X[3].(*Pattern),
      Comma: X[4].(*Keyword),
      RightPattern: X[5].(*Pattern),
      ExtraComma: X[6].(*Keyword),
      CloseParen: X[7].(*Keyword),
    }}, nil >>`,
		Id:         "StartExtension",
		NTType:     18,
		Index:      49,
	...
	ProdTabEntry{
		String:     `ContinueExtension : Pattern	<<  >>`,
		Id:         "ContinueExtension",
		NTType:     19,
		Index:      50,
		NumSymbols: 1,
		ReduceFunc: func(X []Attrib, C interface{}) (Attrib, error) {
	...
	ProdTabEntry{
		String: `ContinueExtension : ContinueExtension Comma Pattern	<< &Pattern{Extension: &Extension{
      LeftPattern: X[0].(*Pattern),
      Comma: X[1].(*Keyword),
      RightPattern: X[2].(*Pattern),
    }}, nil >>`,
	...
	ProdTabEntry{
		String:     `Dollar : "$"	<< &Keyword{Value: "$"}, nil >>`,
		Id:         "Dollar",
		NTType:     63,
		Index:      166,
		NumSymbols: 1,
