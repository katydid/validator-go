...
func main() {
	...
	gen(compareStr, "compare.gen.go", []interface{}{
		...
		&compare{"ge", ">=", "string", "return strings.Compare(v1, v2) >= 0, nil", "String", "false", "greater than or equal"},
		...
		&compare{"gt", ">", "string", "return strings.Compare(v1, v2) > 0, nil", "String", "false", "greater than"},
		...
		&compare{"le", "<=", "string", "return strings.Compare(v1, v2) <= 0, nil", "String", "false", "less than or equal"},
		...
		&compare{"lt", "<", "string", "return strings.Compare(v1, v2) < 0, nil", "String", "false", "less than"},
